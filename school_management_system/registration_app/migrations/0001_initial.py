    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('emergency_contact2_name', models.CharField(blank=True, max_length=50, null=True)),
                ('emergency_contact2_phone', models.CharField(blank=True, max_length=15, null=True)),
                ('emergency_contact2_relationship', models.CharField(blank=True, max_length=30, null=True)),
